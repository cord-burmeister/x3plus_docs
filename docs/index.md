...
![L0 Base hardware is driving](images/L0-Base-DRIVE.gif)

Having a gazebo simulation environment

![Having a gazebo environment](images/gz-fly-through.gif)

Drive around in the simulation

![Drive around in the simulation](images/gz-l0-base-drive.gif)